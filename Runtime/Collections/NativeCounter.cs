...
{
	/// <summary>
	/// Implements a NativeCounter for ParallelFor jobs that need to increment or sum a value.
	/// 
	/// LICENSE: Unity Companion License
	/// URL: https://unity3d.com/legal/licenses/Unity_Companion_License
	/// Source: https://github.com/Unity-Technologies/EntityComponentSystemSamples/blob/a6b5ca01e96f4dd859fdb921bda2943323386038/Samples/Assets/NativeCounterDemo/NativeCounter.cs
	/// Modifications:
	/// - Add(int value) method added to supplement Increment()
	/// </summary>
	...
	[StructLayout(LayoutKind.Sequential)]
	[NativeContainer]
	public unsafe struct NativePerThreadCounter : IDisposable
	{
		// The actual pointer to the allocated count needs to have restrictions relaxed so jobs can be schedled with this container
		[NativeDisableUnsafePtrRestriction] private int* m_Counter;
